...
// Pattern: Advanced Linked List
// Difficulty: Hard
// Theme: Group reversal

const VISUALIZATION_STEPS = [
    {
        "desc": "Processing group 1: indices [0,2]",
        "formula": "Reversing 3 nodes in this group",
        "data": [
            1,
            2,
            3,
    ...
    {
        "desc": "Processing group 2: indices [3,5]",
        "formula": "Reversing 3 nodes in this group",
        "data": [
            1,
            2,
    ...
    {
        "desc": "Processing group 3: indices [6,8]",
        "formula": "Reversing 3 nodes in this group",
        "data": [
            1,
            2,
