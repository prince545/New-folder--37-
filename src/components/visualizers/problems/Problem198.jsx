...
export default function Problem198() {
    const [stepIndex, setStepIndex] = useState(0);
    const [isPlaying, setIsPlaying] = useState(false);

    // Dummy logic for House Robber
    // TODO: Implement actual algorithm tracing for House Robber
    const steps = [
        { desc: "Initial state for House Robber", data: [1, 2, 3, 4, 5], pointers: { i: 0 } },
