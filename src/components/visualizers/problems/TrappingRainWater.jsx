...
// Pattern: Signature Hard
// Difficulty: Hard
// Theme: Two-pointer / stack

const VISUALIZATION_STEPS = [
    {
        "desc": "At index 0: height=0, leftMax=0, rightMax=3",
        "formula": "water = min(0,3) - 0 = 0",
        "data": [
            0,
            1,
            0,
    ...
    {
        "desc": "At index 1: height=1, leftMax=1, rightMax=3",
        "formula": "water = min(1,3) - 1 = 0",
        "data": [
            0,
            1,
            0,
    ...
    {
        "desc": "At index 2: height=0, leftMax=1, rightMax=3",
        "formula": "water = min(1,3) - 0 = 1",
        "data": [
            0,
            1,
            0,
    ...
    {
        "desc": "At index 3: height=2, leftMax=2, rightMax=3",
        "formula": "water = min(2,3) - 2 = 0",
        "data": [
            0,
            1,
            0,
    ...
    {
        "desc": "At index 4: height=1, leftMax=2, rightMax=3",
        "formula": "water = min(2,3) - 1 = 1",
        "data": [
            0,
            1,
            0,
    ...
    {
        "desc": "At index 5: height=0, leftMax=2, rightMax=3",
        "formula": "water = min(2,3) - 0 = 2",
        "data": [
            0,
            1,
            0,
    ...
    {
        "desc": "At index 6: height=1, leftMax=2, rightMax=3",
        "formula": "water = min(2,3) - 1 = 1",
        "data": [
            0,
            1,
    ...
    {
        "desc": "At index 7: height=3, leftMax=3, rightMax=3",
        "formula": "water = min(3,3) - 3 = 0",
        "data": [
            0,
            1,
            0,
                    ...
                    <div>
                        ...
                        <div className="flex gap-2 mt-2">
                            ...
                            <span className={`text-xs ${
                                'Hard' === 'Easy' ? 'bg-green-500/20 text-green-300' :
                                'Hard' === 'Medium' ? 'bg-yellow-500/20 text-yellow-300' :
