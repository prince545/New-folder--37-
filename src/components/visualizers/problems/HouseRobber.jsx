...
const VISUALIZATION_STEPS = [
    {
        "desc": "Deciding to rob house 0 (value: 2)",
        "formula": "dp[0] = max(dp[-2] + 2, dp[-1]) = 2",
        "data": [
            2,
            7,
            9,
    ...
    {
        "desc": "Deciding to rob house 1 (value: 7)",
        "formula": "dp[1] = max(dp[-1] + 7, dp[0]) = 7",
        "data": [
            2,
            7,
            9,
    ...
    {
        "desc": "Deciding to rob house 2 (value: 9)",
        "formula": "dp[2] = max(dp[0] + 9, dp[1]) = 11",
        "data": [
            2,
            7,
            9,
    ...
    {
        "desc": "Deciding to rob house 3 (value: 3)",
        "formula": "dp[3] = max(dp[1] + 3, dp[2]) = 11",
        "data": [
            2,
            7,
            9,
    ...
    {
        "desc": "Deciding to rob house 4 (value: 1)",
        "formula": "dp[4] = max(dp[2] + 1, dp[3]) = 12",
        "data": [
            2,
            7,
            9,
    ...
    {
        "desc": "Deciding to rob house 5 (value: undefined)",
        "formula": "dp[5] = max(dp[3] + undefined, dp[4]) = 0",
        "data": [
            2,
            7,
            9,
    ...
    {
        "desc": "Deciding to rob house 6 (value: undefined)",
        "formula": "dp[6] = max(dp[4] + undefined, dp[5]) = 0",
        "data": [
            2,
            7,
            9,
    ...
    {
        "desc": "Deciding to rob house 7 (value: undefined)",
        "formula": "dp[7] = max(dp[5] + undefined, dp[6]) = 0",
        "data": [
            2,
            7,
            9,
