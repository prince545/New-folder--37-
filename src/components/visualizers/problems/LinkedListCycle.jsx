...
// Pattern: Linked List Cycle / Fast-Slow
// Difficulty: Easy
// Theme: Floyd's cycle detection

const VISUALIZATION_STEPS = [
    {
        "desc": "Slow pointer at 0, fast pointer at 0",
    ...
    {
        "desc": "Slow pointer at 1, fast pointer at 2",
        "formula": "Moving pointers...",
        "data": [
            3,
            2,
            0,
    ...
    {
        "desc": "Slow pointer at 2, fast pointer at 0",
        "formula": "Moving pointers...",
        "data": [
            3,
            2,
    ...
    {
        "desc": "Slow pointer at 3, fast pointer at 2",
        "formula": "Moving pointers...",
        "data": [
            3,
            2,
