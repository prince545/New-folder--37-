...
// Difficulty: Medium
// Theme: BFS with queue

const VISUALIZATION_STEPS = [
    {
        "desc": "Processing level 0: [3]",
        "formula": "Queue size = 1",
        "data": [
            3,
            9,
            20,
    ...
    {
        "desc": "Processing level 1: [9,20]",
        "formula": "Queue size = 2",
        "data": [
            3,
            9,
            20,
    ...
    {
        "desc": "Processing level 2: [15,7]",
        "formula": "Queue size = 4",
        "data": [
            3,
            9,
            20,
    ...
    {
        "desc": "Processing level 3: []",
        "formula": "Queue size = 0",
        "data": [
            3,
            9,
            20,
