...
// Difficulty: Medium
// Theme: Sliding window with set

const VISUALIZATION_STEPS = [
    {
        "desc": "Window [0,0]: \"a\"",
        "formula": "unique chars = 1, length = 1",
        "data": [
            "a",
            "b",
            "c",
    ...
    {
        "desc": "Window [0,1]: \"ab\"",
        "formula": "unique chars = 2, length = 2",
        "data": [
            "a",
            "b",
            "c",
    ...
    {
        "desc": "Window [0,2]: \"abc\"",
        "formula": "unique chars = 3, length = 3",
        "data": [
            "a",
            "b",
            "c",
    ...
    {
        "desc": "Window [4,6]: \"bcb\"",
        "formula": "unique chars = 2, length = 3",
        "data": [
            "a",
            "b",
            "c",
