...
// Difficulty: Medium
// Theme: BST property check

const VISUALIZATION_STEPS = [
    {
        "desc": "Checking node 2: valid range [-5, 5]",
        "formula": "2 between -5 and 5? ✓",
        "data": [
            2,
            1,
            3
    ...
    {
        "desc": "Checking node 1: valid range [-4, 6]",
        "formula": "1 between -4 and 6? ✓",
        "data": [
            2,
            1,
            3
    ...
    {
        "desc": "Checking node 3: valid range [-3, 7]",
        "formula": "3 between -3 and 7? ✓",
        "data": [
            2,
            1,
            3
    ...
    {
        "desc": "Checking node 2: valid range [-2, 8]",
        "formula": "2 between -2 and 8? ✓",
        "data": [
            2,
            1,
            3
    ...
    {
        "desc": "Checking node 1: valid range [-1, 9]",
        "formula": "1 between -1 and 9? ✓",
        "data": [
            2,
            1,
            3
    ...
    {
        "desc": "Checking node 3: valid range [0, 10]",
        "formula": "3 between 0 and 10? ✓",
        "data": [
            2,
            1,
            3
    ...
    {
        "desc": "Checking node 2: valid range [1, 11]",
        "formula": "2 between 1 and 11? ✓",
        "data": [
            2,
            1,
            3
    ...
    {
        "desc": "Checking node 1: valid range [2, 12]",
        "formula": "1 between 2 and 12? ✗",
        "data": [
            2,
            1,
            3
