...
// Difficulty: Medium
// Theme: Permutation pattern

const VISUALIZATION_STEPS = [
    {
        "desc": "Building permutation: swapping indices 0 and 1",
        "formula": "swap(1, 2)",
        "data": [
            1,
            2,
    ...
    {
        "desc": "Building permutation: swapping indices 1 and 2",
        "formula": "swap(2, 3)",
        "data": [
            1,
            2,
    ...
    {
        "desc": "Building permutation: swapping indices 2 and 0",
        "formula": "swap(3, 1)",
        "data": [
            1,
            2,
