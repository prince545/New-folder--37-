...
const CODE_LINES = [
    { line: "int orangesRotting(vector<vector<int>>& grid) {" },
    { line: "    int R=grid.size(), C=grid[0].size();" },
    { line: "    queue<tuple<int,int,int>> q;" },
    { line: "    int fresh = 0, minutes = 0;" },
    { line: "    for (int r=0; r<R; r++) {" },
    { line: "        for (int c=0; c<C; c++) {" },
    { line: "            if (grid[r][c]==2) q.push({r,c,0});" },
    { line: "            if (grid[r][c]==1) fresh++;" },
    { line: "        }" },
    { line: "    }" },
