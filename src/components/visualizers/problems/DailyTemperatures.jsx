...
// Difficulty: Medium
// Theme: Next greater element

const VISUALIZATION_STEPS = [
    {
        "desc": "Processing index 0: temp=73, stack has 0 elements",
        "formula": "Pushing to stack",
        "data": [
            73,
            74,
            75,
    ...
    {
        "desc": "Processing index 1: temp=74, stack has 1 elements",
        "formula": "Found warmer: 74 > 73",
        "data": [
            73,
            74,
            75,
    ...
    {
        "desc": "Processing index 2: temp=75, stack has 1 elements",
        "formula": "Found warmer: 75 > 74",
        "data": [
            73,
            74,
            75,
    ...
    {
        "desc": "Processing index 3: temp=71, stack has 2 elements",
        "formula": "Pushing to stack",
        "data": [
            73,
            74,
    ...
    {
        "desc": "Processing index 4: temp=69, stack has 2 elements",
        "formula": "Pushing to stack",
        "data": [
            73,
            74,
    ...
    {
        "desc": "Processing index 5: temp=72, stack has 3 elements",
        "formula": "Found warmer: 72 > 69",
        "data": [
            73,
            74,
            75,
    ...
    {
        "desc": "Processing index 6: temp=76, stack has 3 elements",
        "formula": "Found warmer: 76 > 72",
        "data": [
            73,
            74,
            75,
    ...
    {
        "desc": "Processing index 7: temp=73, stack has 4 elements",
        "formula": "Pushing to stack",
        "data": [
            73,
            74,
