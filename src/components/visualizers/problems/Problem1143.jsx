...
export default function Problem1143({ approach = "optimal" }) {
    ...
    // BRUTE FORCE LOGIC
    const stepsBrute = [
        { desc: "Brute Force approach for Longest Common Subsequence", data: [[1, 2], [3, 4]], pointers: { r: 0, c: 0 }, scalars: { approach: "Brute Force O(N^2) or worse" } },
        { desc: "Nested loops processing...", data: [[1, 2], [3, 4]], pointers: { r: 0, c: 1 }, scalars: { approach: "Brute Force" } }
    ];

    // BETTER LOGIC
    const stepsBetter = [
        { desc: "Better approach for Longest Common Subsequence", data: [[1, 2], [3, 4]], pointers: { r: 0, c: 0 }, scalars: { approach: "Better (e.g. O(N log N))" } },
        { desc: "Optimizing state...", data: [[1, 2], [3, 4]], pointers: { r: 0, c: 1 }, scalars: { approach: "Better" } }
    ];

    // OPTIMAL LOGIC
    const stepsOptimal = [
        { desc: "Optimal approach for Longest Common Subsequence", data: [[1, 2], [3, 4]], pointers: { r: 0, c: 0 }, scalars: { approach: "Optimal O(N)" } },
        { desc: "Directly solving...", data: [[1, 2], [3, 4]], pointers: { r: 1, c: 1 }, scalars: { approach: "Optimal" } }
    ];
