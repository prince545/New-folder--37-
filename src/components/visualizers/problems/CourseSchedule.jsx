...
// Difficulty: Medium
// Theme: Cycle detection

const VISUALIZATION_STEPS = [
    {
        "desc": "Processing course 0 with indegree = 0",
        "formula": "No prerequisites",
        "data": [
            0,
            1,
            2,
    ...
    {
        "desc": "Processing course 1 with indegree = 1",
        "formula": "Depends on course 0",
        "data": [
            0,
            1,
            2,
    ...
    {
        "desc": "Processing course 2 with indegree = 2",
        "formula": "Depends on course 1",
        "data": [
            0,
            1,
            2,
    ...
    {
        "desc": "Processing course 3 with indegree = 3",
        "formula": "Depends on course 2",
        "data": [
            0,
            1,
            2,
    ...
    {
        "desc": "Processing course 4 with indegree = 4",
        "formula": "Depends on course 3",
        "data": [
            0,
            1,
            2,
    ...
    {
        "desc": "Processing course 5 with indegree = 5",
        "formula": "Depends on course 4",
        "data": [
            0,
            1,
            2,
    ...
    {
        "desc": "Processing course 6 with indegree = 6",
        "formula": "Depends on course 5",
        "data": [
            0,
            1,
            2,
    ...
    {
        "desc": "Processing course 7 with indegree = 7",
        "formula": "Depends on course 6",
        "data": [
            0,
            1,
            2,
