...
// Pattern: Prefix Sum
// Difficulty: Medium
// Theme: Hashmap + prefix

const VISUALIZATION_STEPS = [
    {
        "desc": "Initialize prefix sum map with {0:1}",
        "formula": "prefixSum[0] = 1, looking for sum - k = -2",
        "data": [
            1,
            1,
            1,
    ...
    {
        "desc": "Process index 1, current sum = 2",
        "formula": "prefixSum[1] = 2, looking for sum - k = -1",
        "data": [
            1,
            1,
            1,
    ...
    {
        "desc": "Process index 2, current sum = 3",
        "formula": "prefixSum[2] = 3, looking for sum - k = 0",
        "data": [
            1,
            1,
            1,
    ...
    {
        "desc": "Process index 3, current sum = 5",
        "formula": "prefixSum[3] = 5, looking for sum - k = 2",
        "data": [
            1,
            1,
            1,
    ...
    {
        "desc": "Process index 4, current sum = 4",
        "formula": "prefixSum[4] = 4, looking for sum - k = 1",
        "data": [
            1,
            1,
            1,
    ...
    {
        "desc": "Process index 5, current sum = 5",
        "formula": "prefixSum[5] = 5, looking for sum - k = 2",
        "data": [
            1,
            1,
            1,
    ...
    {
        "desc": "Process index 6, current sum = 5",
        "formula": "prefixSum[6] = 5, looking for sum - k = 2",
        "data": [
            1,
            1,
            1,
    ...
    {
        "desc": "Process index 7, current sum = 5",
        "formula": "prefixSum[7] = 5, looking for sum - k = 2",
        "data": [
            1,
            1,
            1,
